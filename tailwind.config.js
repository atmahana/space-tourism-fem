  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "crew-mobile": "url('/backgrounds/destination/background-crew-mobile.jpg')",
        "crew-tablet": "url('/backgrounds/destination/background-crew-tablet.jpg')",
        "crew-desktop": "url('/backgrounds/destination/background-crew-desktop.jpg')",
        "tech-mobile": "url('/backgrounds/destination/background-technology-mobile.jpg')",
        "tech-tablet": "url('/backgrounds/destination/background-technology-tablet.jpg')",
        "tech-desktop": "url('/backgrounds/destination/background-technology-desktop.jpg')",
      },
      width: {
        37: "9.375rem",
        62: '15.125rem',
