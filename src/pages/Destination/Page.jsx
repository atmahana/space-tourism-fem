      ...
      <div className="pt-[5.5rem] md:pt-[8.5rem] xl:pt-[13rem] 2xl:pt-[11.5rem] flex flex-col items-center md:items-start md:px-[2.375rem] xl:px-[10.375rem] 2xl:px-[18rem]">
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[9.8rem] xl:ml-16 2xl:mt-0">
          <SwipeableTabs
            ...
            tabStyle="text-secondary uppercase font-sans-condensed tracking-235 md:tracking-270 text-sm md:text-base 2xl:text-lg h-[1.875rem] md:h-[2.375rem] xl:h-9 xl:leading-tight cursor-pointer hover:border-b-[3px] border-white/50"
