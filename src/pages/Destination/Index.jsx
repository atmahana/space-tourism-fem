...
function DestinationPage() {
  ...
  return (
    <section className="bg-dest-mobile md:max-xl:bg-dest-tablet xl:bg-dest-desktop bg-cover h-full text-center overflow-auto">
      <div className="pt-[5.5rem] md:max-xl:pt-[8.5rem] xl:pt-[13rem] 2xl:pt-[11.5rem] flex flex-col items-center md:items-start md:max-xl:px-[2.375rem] xl:px-[10.375rem] 2xl:px-[18rem]">
