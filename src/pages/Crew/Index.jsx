...
function CrewPage() {
  return (
    <section className="bg-crew-mobile md:bg-crew-tablet xl:bg-crew-desktop h-screen bg-cover overflow-hidden">
      <div className="pt-[5.5rem] md:pt-[8.3rem] xl:pt-[13rem] 2xl:pt-[11.5rem] flex flex-col items-center md:items-start md:px-[2.375rem] xl:px-[10.375rem] 2xl:px-[18rem]">
        ...
        <SwipeableTabs
          ...
          selectedTabStyle="bg-white/100 w-full h-full"
        >
...
export default Transition(CrewPage);
