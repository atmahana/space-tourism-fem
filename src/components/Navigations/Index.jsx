...
function NavBar() {
  ...
  return (
    <header className="fixed z-50 top-0 inset-x-0 h-[88px] px-6 md:max-lg:px-[39px] lg:px-14">
      <div className="w-1/3 2xl:w-[55%] h-[1px] hidden xl:block bg-white/[0.25] absolute top-[5.375rem] left-46 z-10" />
